...
from scripts.agent_flow.functions.logic_tree_evaluator import evaluate_logic_tree
from scripts.agent_flow.functions.selection_resolver import resolve_selection_scope
...
CASES: Sequence[CaseConfig] = (
    {
        "name": "0059",
        "policy_master": "scripts/artifacts/policy_artifacts/0059/policy_master_v4.json",
        "route_index": "scripts/artifacts/policy_artifacts/0059/route_index_v4.json",
        "scoped": "scripts/artifacts/fixtures/screen_payloads/0059/selected_scope_context.json",
        "result_map": "scripts/artifacts/fixtures/screen_payloads/0059/criterion_result_map.json",
        "expected": {
    ...
    },
    {
        ...
        "policy_master": "scripts/artifacts/policy_artifacts/0314/policy_master_v4.json",
        "route_index": "scripts/artifacts/policy_artifacts/0314/route_index_v4.json",
        "scoped": "scripts/artifacts/fixtures/screen_payloads/0314/selected_scope_context_INIT_ONC.json",
        "result_map": "scripts/artifacts/fixtures/screen_payloads/0314/criterion_result_map.json",
        "expected": {
            "selected_cluster_satisfied": False,
            "selected_cluster_status": "unresolved",
    ...
    {
        "name": "0655",
        "policy_master": "scripts/artifacts/policy_artifacts/0655/policy_master_v4.json",
        "route_index": "scripts/artifacts/policy_artifacts/0655/route_index_v4.json",
        "scoped": "scripts/artifacts/fixtures/screen_payloads/0655/selected_scope_context.json",
        "result_map": "scripts/artifacts/fixtures/screen_payloads/0655/criterion_result_map.json",
        "expected": {
            "selected_cluster_satisfied": False,
            "selected_cluster_status": "not_satisfied",
            "satisfied_criterion_ids": [],
            "not_satisfied_criterion_ids": ["CR_INIT_UC_DIAG"],
            "criterion_counts": {
                "satisfied": 0,
                "not_satisfied": 1,
                "unresolved": 2,
    ...
    },
    {
        ...
        "policy_master": "scripts/artifacts/policy_artifacts/0685/policy_master_v4.json",
        "route_index": "scripts/artifacts/policy_artifacts/0685/route_index_v4.json",
        "scoped": "scripts/artifacts/fixtures/screen_payloads/0685/selected_scope_context_INIT_NSCLC.json",
        "result_map": "scripts/artifacts/fixtures/screen_payloads/0685/criterion_result_map.json",
        "expected": {
            "selected_cluster_satisfied": False,
            "selected_cluster_status": "unresolved",
...
def _evaluate_case(case: CaseConfig) -> Dict[str, Any]:
    required_paths = [case["policy_master"], case["route_index"], case["scoped"], case["result_map"]]
    ...
    raw_scoped_payload = _load_json(case["scoped"])
    scoped_payload = _rehydrate_scoped_policy_context(
        case,
        raw_scoped_payload.get("scoped_policy_context", raw_scoped_payload),
    )
...
def main() -> int:
    ...
    for result in results:
        if result.get("skipped"):
            ...
            print(json.dumps(result["missing"], indent=2))
            print()
            continue
